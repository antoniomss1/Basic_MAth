...
public class PercentageFragment extends PreferenceFragmentCompat {
    private static final String KEY_START = "precentage_start";
    private static final String KEY_END = "precentage_end";
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.percentage, rootKey);

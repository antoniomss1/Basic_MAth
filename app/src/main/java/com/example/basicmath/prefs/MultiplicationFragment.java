...
public class MultiplicationFragment extends PreferenceFragmentCompat {

        private static final String KEY_START = "table_start";
        private static final String KEY_END = "table_end";

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.multiplication, rootKey);

...
public class AdditionFragment extends PreferenceFragmentCompat {

    private static final String KEY_START = "addition_start";
    private static final String KEY_END = "addition_end";
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.addition, rootKey);
